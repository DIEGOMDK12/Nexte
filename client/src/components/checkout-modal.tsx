            ...
            <div className="space-y-4">
              {PIX_KEY && PIX_KEY !== "Chave PIX não configurada" ? (
                ...
                <div className="p-4 bg-red-900/20 border border-red-700 rounded-lg text-center">
                  ...
                  <p className="text-gray-400 text-sm">O vendedor não configurou uma chave PIX para receber pagamentos.</p>
                  <p className="text-xs text-gray-500 mt-2">Entre em contato com o vendedor para atualizar o pagamento.</p>
                </div>
              )}
