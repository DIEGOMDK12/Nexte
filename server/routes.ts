...
export async function registerRoutes(
  ...
  app.post("/api/settings", (req, res) => {
    ...
    const { storeName, logoUrl, themeColor, textColor, pixKey, adminPixKey, resellerPixKey, pagseguroToken, pagseguroApiUrl, supportEmail, whatsappContact, resellerWhatsapp } = req.body;
